...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    serialized_pb=(
        b'\n\x11PricingData.proto"\x95\x08\n\x0bPricingData\x12\n\n\x02id\x18\x01'
        b" \x01(\t\x12\r\n\x05price\x18\x02 \x01(\x02\x12\x0c\n\x04time\x18\x03"
        b" \x01(\x12\x12\x10\n\x08\x63urrency\x18\x04"
        b" \x01(\t\x12\x10\n\x08\x65xchange\x18\x05 \x01(\t\x12)\n\tquoteType\x18\x06"
        b" \x01(\x0e\x32\x16.PricingData.QuoteType\x12-\n\x0bmarketHours\x18\x07"
        b" \x01(\x0e\x32\x18.PricingData.MarketHours\x12\x15\n\rchangePercent\x18\x08"
        b" \x01(\x02\x12\x11\n\tdayVolume\x18\t"
        b" \x01(\x12\x12\x0f\n\x07\x64\x61yHigh\x18\n"
        b" \x01(\x02\x12\x0e\n\x06\x64\x61yLow\x18\x0b"
        b" \x01(\x02\x12\x0e\n\x06\x63hange\x18\x0c"
        b" \x01(\x02\x12\x11\n\tshortName\x18\r \x01(\t\x12\x12\n\nexpireDate\x18\x0e"
        b" \x01(\x12\x12\x11\n\topenPrice\x18\x0f"
        b" \x01(\x02\x12\x15\n\rpreviousClose\x18\x10"
        b" \x01(\x02\x12\x13\n\x0bstrikePrice\x18\x11"
        b" \x01(\x02\x12\x18\n\x10underlyingSymbol\x18\x12"
        b" \x01(\t\x12\x14\n\x0copenInterest\x18\x13"
        b" \x01(\x12\x12\x13\n\x0boptionsType\x18\x14"
        b" \x01(\x12\x12\x12\n\nminiOption\x18\x15"
        b" \x01(\x12\x12\x10\n\x08lastSize\x18\x16"
        b" \x01(\x12\x12\x0b\n\x03\x62id\x18\x17"
        b" \x01(\x02\x12\x0f\n\x07\x62idSize\x18\x18"
        b" \x01(\x12\x12\x0b\n\x03\x61sk\x18\x19"
        b" \x01(\x02\x12\x0f\n\x07\x61skSize\x18\x1a"
        b" \x01(\x12\x12\x11\n\tpriceHint\x18\x1b"
        b" \x01(\x12\x12\x10\n\x08vol_24hr\x18\x1c"
        b" \x01(\x12\x12\x18\n\x10volAllCurrencies\x18\x1d"
        b" \x01(\x12\x12\x14\n\x0c\x66romcurrency\x18\x1e"
        b" \x01(\t\x12\x12\n\nlastMarket\x18\x1f"
        b" \x01(\t\x12\x19\n\x11\x63irculatingSupply\x18 "
        b" \x01(\x01\x12\x11\n\tmarketcap\x18!"
...
_PRICINGDATA_QUOTETYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="ALTSYMBOL", index=1, number=5, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="HEARTBEAT", index=2, number=7, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="EQUITY", index=3, number=8, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="INDEX", index=4, number=9, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="MUTUALFUND", index=5, number=11, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="MONEYMARKET", index=6, number=12, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="OPTION", index=7, number=13, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="CURRENCY", index=8, number=14, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="WARRANT", index=9, number=15, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="BOND", index=10, number=17, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="FUTURE", index=11, number=18, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="ETF", index=12, number=20, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="COMMODITY", index=13, number=23, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="ECNQUOTE", index=14, number=28, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="CRYPTOCURRENCY",
            index=15,
        ...
        _descriptor.EnumValueDescriptor(
            name="INDICATOR", index=16, number=42, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="INDUSTRY", index=17, number=1000, serialized_options=None, type=None
        ),
    ],
...
_PRICINGDATA_MARKETHOURS = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="PRE_MARKET", index=0, number=0, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="REGULAR_MARKET", index=1, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="POST_MARKET", index=2, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
